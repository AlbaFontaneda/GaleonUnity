...
public class SceneMgr : MonoBehaviour
{
    ...
    //la información de la siguiente escena a cargar. Esto es util si queremos construir un
    ...
    protected IEnumerator LoadingAdditiveAsync(string subScene, bool inStack, OnAsyncLoadingProgress onAsyncLoadingProgress)
    {
        ...
        do
        {
            ...
            //TODO 7 yield return WaitForEndOfFrame bloquea la corrutina hasta el siguiente frame7
            yield return new WaitForEndOfFrame();
